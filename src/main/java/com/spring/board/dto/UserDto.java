...
public class UserDto {
	...
	public String toString() {
		return "UserDto [u_id=" + u_id + ", u_pwd=" + u_pwd + ", u_name=" + u_name + ", u_sex=" + u_sex
				+ ", u_birthday=" + u_birthday + ", u_email=" + u_email + ", u_phone_number=" + u_phone_number
				+ ", u_email_active_key=" + u_email_active_key + ", u_active_state=" + u_active_state + ", u_reg_date="
				+ u_reg_date + ", u_latest_login_date=" + u_latest_login_date + ", u_recommend_active_time="
				+ u_recommend_active_time + "]";
	}
